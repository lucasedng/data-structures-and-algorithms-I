/*
Tarefa 06 - Listas Circulares Duplamente Encadeadas (REMOÇÃO)
Descrição
...
Para este código, implemente a função main.
...
// Lembre-se de liberar a memória da lista antes de sair do programa